...
write.csv(blues, file='Adv_Urb_21blues.csv')
...
write.csv(blues, file='Pr_Urb_21blues.csv')
...
write.csv(blues, file='Adv_Neo_21blues.csv')
...
write.csv(blues, file='Pr_Neo_21blues.csv')
...
write.csv(blues, file='Adv_Stj_21blues.csv')
...
blues<- rbind(bluesY, bluesT)
blues<- blues[,c(1,3,2,4:6)]
write.csv(blues, file='Pr_Stj_21blues.csv')
